...
################################################################################
## Form generated from reading UI file 'design11.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le_track_id = QLineEdit(self.centralwidget)
        self.le_track_id.setObjectName(u"le_track_id")

        self.verticalLayout_17.addWidget(self.le_track_id)

        self.pe_track_id = QPlainTextEdit(self.centralwidget)
        self.pe_track_id.setObjectName(u"pe_track_id")
        self.pe_track_id.setReadOnly(True)

        self.verticalLayout_17.addWidget(self.pe_track_id)

        self.btn_copy_track_id = QPushButton(self.centralwidget)
        self.btn_copy_track_id.setObjectName(u"btn_copy_track_id")

        self.verticalLayout_17.addWidget(self.btn_copy_track_id)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"\u0422\u0440\u0435\u043a-\u043d\u043e\u043c\u0435\u0440\u0430:", None))
        self.btn_copy_track_id.setText(QCoreApplication.translate("MainWindow", u"\u0421\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u0442\u044c", None))
    # retranslateUi
