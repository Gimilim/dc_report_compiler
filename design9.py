...
################################################################################
## Form generated from reading UI file 'design9.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.pe_log.sizePolicy().hasHeightForWidth())
        self.pe_log.setSizePolicy(sizePolicy1)
        ...
        self.formLayout_2.setLayout(0, QFormLayout.FieldRole, self.verticalLayout_3)
        ...
        self.le_uplouaded = QLineEdit(self.centralwidget)
        self.le_uplouaded.setObjectName(u"le_uplouaded")

        self.verticalLayout.addWidget(self.le_uplouaded)

        self.pe_uplouded = QPlainTextEdit(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_load.setText(QCoreApplication.translate("MainWindow", u"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c", None))
